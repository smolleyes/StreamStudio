...
//var server = http.createServer(function(req, res) {
  ...
  //var connector = (options.protocol == 'https:' ? https : http).request(options, function(serverResponse) {
    ...
    //serverResponse.headers['transferMode.dlna.org'] = 'Streaming';
    //serverResponse.headers['contentFeatures.dlna.org'] = 'DLNA.ORG_OP=01;DLNA.ORG_CI=0;DLNA.ORG_FLAGS=017000 00000000000000000000000000';
    ...
    //switch (serverResponse.statusCode) {
      ...
      //case 303:
        ...
        //serverResponse.headers['location'] = 'http://'+ipaddress+':'+PORT+'/'+serverResponse.headers['location'];
