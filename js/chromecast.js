...
var Chromecast = function(device) {
		
		this._makeID = function (baseID) {
			return 'chromecast-' + baseID.replace(/\s/g, '-');
		},
		...
		this.play = function (streamModel) {
			var self = this;
		...
		this.seekTo =function (newCurrentTime) {
		...
		this._internalStatusUpdated =function (status) {
	...
	browser.on('deviceOn', function(device){
		var cr = new Chromecast({device:browser.device})
