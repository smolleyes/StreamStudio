...
function init (appState, listUpdateCb,updateStateCb) {
  try {
    ...
    reloadNetworkPlayersList = listUpdateCb
...
function chromecastPlayer () {
  ...
  function addDevice (device) {
    device.on('error', function (err) {
      ...
      console.log('Update chromecast list')
    ...
    reloadNetworkPlayersList ? reloadNetworkPlayersList(state) : null;
  }
  function open () {
...
function selectDevice (index) {
  ...
  reloadNetworkPlayersList(state)
}
