...
var createServer = function (e, opts) {
  ...
  var onready = function () {
    //if(e.files.length > 1 && opts.analysed !== true) {
       //var buf = pt.toTorrentFile(e.torrent)
       //opts.gui.getTorrent(buf)
    //}
  ...
  server.on('request', function (request, response) {
    console.log('PEERFLIX REQUESTTTTTTT' , request.headers)
    ...
    response.setHeader('contentFeatures.dlna.org', 'DLNA.ORG_OP=01;DLNA.ORG_CI=0;DLNA.ORG_FLAGS=017000 00000000000000000000000000')
    if (request.method === 'HEAD') return response.end()
      console.log('PEERFLIX REPONSE' , response)
