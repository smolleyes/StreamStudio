...
var createServer = function(e, opts) {
	...
	server.on('request', function(request, response) {
		...
		response.setHeader('contentFeatures.dlna.org','DLNA.ORG_OP=01;DLNA.ORG_CI=0;DLNA.ORG_FLAGS=01500000000000000000000000000000');
		response.setHeader('realTimeInfo.dlna.org','DLNA.ORG_TLAG=*');
