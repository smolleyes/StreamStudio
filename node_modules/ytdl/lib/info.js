 ...
 */
module.exports = function getInfo(link, video, opts, callback) {
  var optsClone;
  ...
  crequest(optsClone, function(err, body) {
    ...
    if (jsonStr) {
      parseJSON(jsonStr, function(err, config) {
        if (err) return callback(err);
        gotConfig(opts, video, description, config, callback);
      });
    } else {
 ...
 * @param {Function(Error, Object)} callback
 */
function gotConfig(opts, video, description, config, callback) {
