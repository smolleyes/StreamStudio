...
function Element(doc, tagId, ebmlID, start, length) {
	...
	if (!schemaInfo) {
		console.error("Invalid schemaID ", ebmlID && ("0x" + ebmlID.toString(16)), "tagId=", tagId, "doc=", doc);
...
Element.prototype.print = function(level) {
	...
	if (this.masterType) {
		...
		if (this.dataSize || this.data) {
			s += "  b[" + ((this.data && this.data.length) || this.dataSize) + "]";
...
Element.prototype.getTagByPosition = function(position, contentOffset) {
	// console.log("Search " + this._name + " " + position + " " + this.dataSize);
...
Element.prototype.getDataStream = function(callback) {
	...
	if (this._dataSource) {
		this._dataSource.getStream(-1, -1, callback);
		return;
	}
