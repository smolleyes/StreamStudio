...
upnpClient.prototype._init = function() {
    this._client = new RendererFinder();
    // this._client = dgram.createSocket({
    //     type: 'udp4',
    //     reuseAddr: true
    // })
    // var self = this;
    // this._client.bind(PORT, function() {
...
upnpClient.prototype._start = function() {
    ...
    self._client.on('found',function(err, info, msg){
        self.parseDevice(info);
    });
    ...
    self.on('searchDevicesEnd', function onMessage(device, type) {
        console.log("SSDP SEARCH END");
    })
...
upnpClient.prototype.searchDevices = function() {
    ...
    // emit terminated search signal after 30 seconds
    setTimeout(function() {
...
upnpClient.prototype.parseDevice = function(msg) {
    ...
    //} else {
        ...
        http.get(location, function(res) {
            ...
            res.on('end', function() {
                if (doc.search('<manufacturer>Google Inc.</manufacturer>') !== -1) {
                    console;log("CHROMECAST DEVICE FOUND", doc)
                }
                var xmldoc;
                try {
                ...
                sList.eachChild(function(item) {
                    ...
                    try {
                        ...
                        device.icon = '/images/movie_file.png'
                    }
                    device.online = true;
                    ...
                    try {
                        ...
                        if (service.serviceType.indexOf("urn:schemas-upnp-org:service:ContentDirectory") !== -1) {
